...
add_filter("gform_submit_button_3", "form_submit_button", 3);
function form_submit_button($button, $form){
return "<button class='button' id='gform_submit_button_{$form["id"]}'><i class='fa fa-fw fa-envelope-o'></i></button>";
}
